...
class CreateEnviosRetornadosTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('envios_retornados', function (Blueprint $table) {
            $table->increments('id');

            $table->dateTime('fecha_reporte_retornado')->nullable();
    ...
    {
        Schema::dropIfExists('envios_retornados');
    }
}
